...
library("readr")
library("magrittr")
# input_file <- file.path("../data/GSE103322_HNSCC","HNSCC_all_data_partial2.txt")
input_file <- file.path("../data/GSE103322_HNSCC","HNSCC_all_data.txt")
...
# object.size(expression_table)
mydata <- CreateSeuratObject(counts = expression_table,
                             min.cells = 3,
                             min.features = 200,
                             project = "GSE103322_HNSCC_scRNAseq")
mydata
