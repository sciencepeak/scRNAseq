...
mydata <- CreateSeuratObject(counts = expression_matrix,
                             min.cells = 3,
                             min.features = 200,
                             project = favorite_project_name)
mydata

first_ID <- sapply(colnames(expression_matrix), function(x) strsplit(x, "_")[[1]][1])
table(first_ID)
```
...
DimPlot(object = mydata, reduction = 'umap')
```
